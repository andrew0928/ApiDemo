...
namespace Andrew.ApiDemo.SDK.Security
{
    ...
    public class TokenData
    {
        ...
        public static T DecodeToken<T>(string siteID, string tokenText) where T : TokenData
        {
            bool isSafe;
            bool isSecure;
            bool isValidate;
        ...
        public static T TryDecodeToken<T>(string siteID, string tokenText, out bool isSafe, out bool isSecure, out bool isValidate) where T : TokenData
        {
